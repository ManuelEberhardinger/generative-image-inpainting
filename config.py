...
# Training settings
parser.add_argument('--DATASET', type=str, default='Places', choices=['CelebA', 'Places'])
...
# Path
parser.add_argument('--IMAGE_PATH', type=str, default='/Users/manuel/Downloads/data_256')
...
parser.add_argument('--SHOW_IMAGES', type=str2bool, default=True)
